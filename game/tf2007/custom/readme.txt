...
For example, you might have the following file structure:
	...
	tf2007/custom/my_custom_stuff/   <<< This subfolder will be added as a search path
	tf2007/custom/my_custom_stuff/models/custom_model.mdl
	tf2007/custom/my_custom_stuff/materials/custom_material.vmt
	tf2007/custom/my_custom_stuff/materials/vgui/custom_ui_thing.res
	tf2007/custom/some_mod.vpk       <<< This VPK will be added as a search path
	tf2007/custom/another_mod.vpk    <<< This VPK will be added as a search path
...
Note that the following directory structure is NOT correct:
	...
	tf2007/custom/models/my_model.mdl
...
Instead, you would use something like:
	...
	tf2007/custom/my_custom_stuff/models/my_model.mdl
